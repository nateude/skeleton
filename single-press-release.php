...
<!-- Begin Template: single-press-releases.php  -->
		...
		<div class="wrapper">
			...
			<div class="section onethird right sidebar">
				<div class="widgets list">
					<a href="<?php echo get_option('home'); ?>/press-releases/" class="button blue">View All Press Releases</a>
...
<!-- End Template: single-press-releases.php -->
