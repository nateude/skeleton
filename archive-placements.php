...
<!-- Begin Template: archive-placements.php  -->
		...
		<div class="wrapper">
					...
					?>
						...
						<div class="post post<?=$i?>"><div class='feat'>
							...
							<div class="content">
								...
								<a class="readmore" href="<?=$perma ?>" >Read Full Placement</a>
							</div>
						</div> <!--END post post<?=$i?> -->
			...
			<div class="section onethird right sidebar">
				<div class="full widgets list">
					<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Placements') ) {} ?>
				</div>  <!-- END .section -->
			</div>  <!-- END .section onethird -->
		</div>  <!-- END .wrapper -->
	</div>  <!-- END #content -->

<!-- End Template: archive-placements.php  -->
